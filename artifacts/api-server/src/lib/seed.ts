...
const MN_DEMO_ROUNDS = [
  ...
  },
  {
    roundNumber: 3,
    stateStrength: "MINIMAL",
    defenseBurden: "Defense must establish that the cumulative impact of the Reform Act violation, Brady suppression, and IAC establishes entitlement to relief under Minn. Stat. § 590.01 and that the applicable time-bar is equitably tolled.",
...
CROSS-EXAMINATION BY MS. MWAMBA:
...
const OH_DEMO_FINDINGS = [
  ...
  },
  {
    ...
    proceduralStatus: "Defaulted",
    anticipatedBlock: "Defense counsel failed to file a suppression motion under Ohio Crim.R. 12(C), which is the mandatory vehicle. Post-conviction review will require cause (IAC) and prejudice (suppression). State will invoke procedural default and argue the facts supported extension.",
...
const IN_DEMO_FINDINGS = [
  ...
  },
  {
    ...
    precedentCitation: "466 U.S. 668 (1984)",
    precedentType: "BINDING",
    courtRuling: "Counsel's performance is deficient when it falls below an objective standard of reasonableness; prejudice is established where there is a reasonable probability that, but for the deficient performance, the result of the proceeding would have been different.",
