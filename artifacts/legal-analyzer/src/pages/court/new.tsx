...
import { ArrowLeft, Gavel, Scale, AlertTriangle, Shield } from "lucide-react";
            ...
            <div className="space-y-6">
              <section>
                ...
                <div className="bg-card border border-border rounded-xl overflow-hidden divide-y divide-border h-[400px] overflow-y-auto">
                  {documents.length > 0 ? (
                    documents.map(doc => (
                      <label key={doc.id} className="flex items-center gap-3 p-4 hover:bg-muted/50 cursor-pointer transition-colors">
                        <Checkbox 
              ...
              <Button 
                ...
                onClick={handleStart}
                disabled={createSession.isPending || selectedDocs.size === 0}
              >
